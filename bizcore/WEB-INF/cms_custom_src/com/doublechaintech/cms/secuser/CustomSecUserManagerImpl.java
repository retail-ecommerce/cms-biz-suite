...
import com.doublechaintech.cms.CmsUserContextImpl;
import com.doublechaintech.cms.LoginForm;
import com.doublechaintech.cms.BaseEntity;
import com.doublechaintech.cms.CommonError;
import com.doublechaintech.cms.DAOGroup;
import com.doublechaintech.cms.ManagerGroup;

import com.doublechaintech.cms.UserContextImpl;
import com.doublechaintech.cms.userapp.UserApp;
import com.doublechaintech.cms.CmsUserContext;
import com.doublechaintech.cms.userapp.*;
import com.doublechaintech.cms.listaccess.*;
import com.doublechaintech.cms.objectaccess.*;
import com.doublechaintech.cms.CmsChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(CmsUserContext userContext){
    ...
    public Object resetPassword(CmsUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(CmsUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(CmsUserContext userContext,
    ...
    public SecUser manage(CmsUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(CmsUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(CmsUserContext userContext) {
    ...
    protected Object gotoApp(CmsUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(CmsUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(CmsUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(CmsUserContext userContex, int length){
    ...
    protected String getBeanName(CmsUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(CmsUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(CmsUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(CmsUserContext userContext, UserApp app){
    ...
    public Object home(CmsUserContext userContext) {
    ...
    public Object loginWithEmail(CmsUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(CmsUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(CmsUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(CmsUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(CmsUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(CmsUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(CmsUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(CmsUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(CmsUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        CmsUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected CmsChecker checker;
    public CmsChecker getChecker(){
        return checker;
    }
    
    public void setChecker(CmsChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((CmsChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected CmsUserContextImpl createNewConext(String path) {

        return new CmsUserContextImpl();
    ...
    public Object checkOtherLogin(CmsUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(CmsUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(CmsUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(CmsUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(CmsUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(CmsUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(CmsUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
