...
import com.doublechaintech.cms.secuserblocking.CandidateSecUserBlocking;
import com.doublechaintech.cms.userdomain.CandidateUserDomain;
...
public class SecUserManagerImpl extends CustomCmsCheckerManager implements SecUserManager {
	...
	protected void throwExceptionWithMessage(String value) throws SecUserManagerException{
 	...
 	protected SecUser saveSecUser(CmsUserContext userContext, SecUser secUser, String [] tokensExpr) throws Exception{	
 	...
 	protected SecUser saveSecUserDetail(CmsUserContext userContext, SecUser secUser) throws Exception{	
 	...
 	public SecUser loadSecUser(CmsUserContext userContext, String secUserId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public SecUser searchSecUser(CmsUserContext userContext, String secUserId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected SecUser present(CmsUserContext userContext, SecUser secUser, Map<String, Object> tokens) throws Exception {
 	...
 	public SecUser loadSecUserDetail(CmsUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, allTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	
 	public Object view(CmsUserContext userContext, String secUserId) throws Exception{	
 		SecUser secUser = loadSecUser( userContext, secUserId, viewTokens());
 		return present(userContext,secUser, allTokens());
		
 	}
 	protected SecUser saveSecUser(CmsUserContext userContext, SecUser secUser, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getSecUserDAO().save(secUser, tokens);
 	}
 	protected SecUser loadSecUser(CmsUserContext userContext, String secUserId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfSecUser(secUserId);
		userContext.getChecker().throwExceptionIfHasErrors( SecUserManagerException.class);
	...
	public SecUser loadSecUserWithMobile(CmsUserContext userContext, String mobile, Map<String,Object>tokens) throws Exception{	
 	...
 	protected<T extends BaseEntity> void addActions(CmsUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(CmsUserContext userContext, SecUser secUser, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingSecUser(CmsUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public SecUser clone(CmsUserContext userContext, String fromSecUserId) throws Exception{
	...
	public SecUser internalSaveSecUser(CmsUserContext userContext, SecUser secUser, Map<String,Object> options) throws Exception 
	{
	...
	public SecUser updateSecUserProperty(CmsUserContext userContext,String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingSecUser(userContext, secUserId, secUserVersion, property, newValueExpr, tokensExpr);
	...
	private static final String [] STATUS_SEQUENCE={"BLOCKED"};
 	protected String[] getNextCandidateStatus(CmsUserContext userContext, String currentStatus) throws Exception{
 	...
 	protected void ensureStatus(CmsUserContext userContext, SecUser secUser, String expectedNextStatus) throws Exception{
	...
	protected void checkParamsForTransferingAnotherDomain(CmsUserContext userContext, String secUserId, String anotherDomainId) throws Exception
 	{
	...
	public CandidateUserDomain requestCandidateDomain(CmsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherBlocking(CmsUserContext userContext, String secUserId, String anotherBlockingId) throws Exception
 	{
 	...
 	public SecUser transferToAnotherBlocking(CmsUserContext userContext, String secUserId, String anotherBlockingId) throws Exception
 	{
	...
	public CandidateSecUserBlocking requestCandidateBlocking(CmsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
	...
	public static final String BLOCKED_STATUS = "BLOCKED";
 	protected void checkParamsForBlocking(CmsUserContext userContext, String secUserId, String who, String comments
) throws Exception
 	{
 				userContext.getChecker().checkIdOfSecUser(secUserId);
 	...
 	public SecUserForm blockActionForm(CmsUserContext userContext, String secUserId) throws Exception
 	{
 	...
 	protected SecUserBlocking createBlocking(CmsUserContext userContext, String who, String comments){
 	...
 	protected void checkIfEligibleForBlocking(CmsUserContext userContext, SecUser secUser) throws Exception{
...
//--------------------------------------------------------------
 	...
 	protected SecUserBlocking loadSecUserBlocking(CmsUserContext userContext, String newBlockingId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected UserDomain loadUserDomain(CmsUserContext userContext, String newDomainId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(CmsUserContext userContext, String secUserId, int secUserVersion) throws Exception {
	...
	public SecUser forgetByAll(CmsUserContext userContext, String secUserId, int secUserVersion) throws Exception {
		return forgetByAllInternal(userContext, secUserId, secUserVersion);		
	}
	protected SecUser forgetByAllInternal(CmsUserContext userContext,
			String secUserId, int secUserVersion) throws Exception{
	...
	protected SecUser breakWithUserAppByObjectId(CmsUserContext userContext, String secUserId, String objectIdId,  String [] tokensExpr)
		 throws Exception{
	...
	protected void checkParamsForAddingUserApp(CmsUserContext userContext, String secUserId, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserAppProperties(CmsUserContext userContext, String secUserId,String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateUserAppProperties(CmsUserContext userContext, String secUserId, String id,String title,String appIcon,boolean fullAccess,String permission,String objectType,String objectId,String location, String [] tokensExpr) throws Exception
	{	
	...
	protected UserApp createUserApp(CmsUserContext userContext, String title, String appIcon, boolean fullAccess, String permission, String objectType, String objectId, String location) throws Exception{
	...
	protected void checkParamsForRemovingUserAppList(CmsUserContext userContext, String secUserId, 
	...
	public  SecUser removeUserAppList(CmsUserContext userContext, String secUserId, 
			String userAppIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUserApp(CmsUserContext userContext, String secUserId, 
	...
	public  SecUser removeUserApp(CmsUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUserApp(CmsUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyUserAppFrom(CmsUserContext userContext, String secUserId, 
		String userAppId, int userAppVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserApp(CmsUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateUserApp(CmsUserContext userContext, String secUserId, String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingLoginHistory(CmsUserContext userContext, String secUserId, String fromIp, String description,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistoryProperties(CmsUserContext userContext, String secUserId,String id,String fromIp,String description,String [] tokensExpr) throws Exception {
	...
	public  SecUser updateLoginHistoryProperties(CmsUserContext userContext, String secUserId, String id,String fromIp,String description, String [] tokensExpr) throws Exception
	{	
	...
	protected LoginHistory createLoginHistory(CmsUserContext userContext, String fromIp, String description) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistoryList(CmsUserContext userContext, String secUserId, 
	...
	public  SecUser removeLoginHistoryList(CmsUserContext userContext, String secUserId, 
			String loginHistoryIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingLoginHistory(CmsUserContext userContext, String secUserId, 
	...
	public  SecUser removeLoginHistory(CmsUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingLoginHistory(CmsUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	public  SecUser copyLoginHistoryFrom(CmsUserContext userContext, String secUserId, 
		String loginHistoryId, int loginHistoryVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingLoginHistory(CmsUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  SecUser updateLoginHistory(CmsUserContext userContext, String secUserId, String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
