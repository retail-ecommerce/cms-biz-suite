...
import com.doublechaintech.cms.secuser.SecUserCustomManagerImpl;
...
public class CmsUserContextImpl extends UserContextImpl implements CmsUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.cms.CmsResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.cms.CmsCustomResources";
    ...
    /*
    public static SecUser getSecUser(CmsUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(CmsUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(CmsUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(CmsUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
