...
import com.doublechaintech.cms.genericform.CandidateGenericForm;
...
public class FormFieldManagerImpl extends CustomCmsCheckerManager implements FormFieldManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormFieldManagerException{
 	...
 	protected FormField saveFormField(CmsUserContext userContext, FormField formField, String [] tokensExpr) throws Exception{	
 	...
 	protected FormField saveFormFieldDetail(CmsUserContext userContext, FormField formField) throws Exception{	

 		
 		return saveFormField(userContext, formField, allTokens());
 	}
 	
 	public FormField loadFormField(CmsUserContext userContext, String formFieldId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormField searchFormField(CmsUserContext userContext, String formFieldId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormField present(CmsUserContext userContext, FormField formField, Map<String, Object> tokens) throws Exception {
 	...
 	public FormField loadFormFieldDetail(CmsUserContext userContext, String formFieldId) throws Exception{	
 		FormField formField = loadFormField( userContext, formFieldId, allTokens());
 		return present(userContext,formField, allTokens());
		
 	}
 	
 	public Object view(CmsUserContext userContext, String formFieldId) throws Exception{	
 		FormField formField = loadFormField( userContext, formFieldId, viewTokens());
 		return present(userContext,formField, allTokens());
		
 	}
 	protected FormField saveFormField(CmsUserContext userContext, FormField formField, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormFieldDAO().save(formField, tokens);
 	}
 	protected FormField loadFormField(CmsUserContext userContext, String formFieldId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormField(formFieldId);
		userContext.getChecker().throwExceptionIfHasErrors( FormFieldManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(CmsUserContext userContext, FormField formField, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(CmsUserContext userContext, FormField formField, Map<String, Object> tokens){
	...
	public FormField createFormField(CmsUserContext userContext,String label, String localeKey, String parameterName, String type, String formId, String placeholder, String defaultValue, String description, String fieldGroup, String minimumValue, String maximumValue, boolean required, boolean disabled, boolean customRendering, String candidateValues, String suggestValues) throws Exception
	{
	...
	protected void checkParamsForUpdatingFormField(CmsUserContext userContext,String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormField clone(CmsUserContext userContext, String fromFormFieldId) throws Exception{
		
		return userContext.getDAOGroup().getFormFieldDAO().clone(fromFormFieldId, this.allTokens());
	}
	
	public FormField internalSaveFormField(CmsUserContext userContext, FormField formField) throws Exception 
	{
		return internalSaveFormField(userContext, formField, allTokens());

	}
	public FormField internalSaveFormField(CmsUserContext userContext, FormField formField, Map<String,Object> options) throws Exception 
	{
	...
	public FormField updateFormField(CmsUserContext userContext,String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormField(userContext, formFieldId, formFieldVersion, property, newValueExpr, tokensExpr);
	...
	public FormField updateFormFieldProperty(CmsUserContext userContext,String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormField(userContext, formFieldId, formFieldVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(CmsUserContext userContext, String formFieldId, String anotherFormId) throws Exception
 	{
 	...
 	public FormField transferToAnotherForm(CmsUserContext userContext, String formFieldId, String anotherFormId) throws Exception
 	{
	...
	public CandidateGenericForm requestCandidateForm(CmsUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected GenericForm loadGenericForm(CmsUserContext userContext, String newFormId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(CmsUserContext userContext, String formFieldId, int formFieldVersion) throws Exception {
	...
	public FormField forgetByAll(CmsUserContext userContext, String formFieldId, int formFieldVersion) throws Exception {
		return forgetByAllInternal(userContext, formFieldId, formFieldVersion);		
	}
	protected FormField forgetByAllInternal(CmsUserContext userContext,
			String formFieldId, int formFieldVersion) throws Exception{
	...
	public void onNewInstanceCreated(CmsUserContext userContext, FormField newCreated) throws Exception{
