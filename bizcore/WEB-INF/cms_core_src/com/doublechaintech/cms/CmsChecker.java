...
public class CmsChecker extends BaseChecker{
	
	
	protected CmsUserContext userContext;
	public CmsUserContext getUserContext() {
		return userContext;
	}
	public void setUserContext(CmsUserContext userContext) {
	...
	public CmsChecker checkIdOfPlatform(String id)
	{
	...
	public CmsChecker checkNameOfPlatform(String name)
	{
	...
	public CmsChecker checkIntroductionOfPlatform(String introduction)
	{
	...
	public CmsChecker checkCurrentVersionOfPlatform(String currentVersion)
	{
	...
	public CmsChecker checkVersionOfPlatform(int version)
	{
	...
	public CmsChecker checkNameOfUserDomain(String name)
	{
	...
	public CmsChecker checkVersionOfUserDomain(int version)
	{
	...
	public CmsChecker checkIdOfUserWhiteList(String id)
	{
	...
	public CmsChecker checkUserIdentityOfUserWhiteList(String userIdentity)
	{
	...
	public CmsChecker checkUserSpecialFunctionsOfUserWhiteList(String userSpecialFunctions)
	{
	...
	public CmsChecker checkDomainIdOfUserWhiteList(String domainId)
	{
	...
	public CmsChecker checkVersionOfUserWhiteList(int version)
	{
	...
	public CmsChecker checkIdOfSecUser(String id)
	{
	...
	public CmsChecker checkLoginOfSecUser(String login)
	{
	...
	public CmsChecker checkMobileOfSecUser(String mobile)
	{
	...
	public CmsChecker checkEmailOfSecUser(String email)
	{
	...
	public CmsChecker checkPwdOfSecUser(String pwd)
	{
	...
	public CmsChecker checkVerificationCodeOfSecUser(int verificationCode)
	{
	...
	public CmsChecker checkVerificationCodeExpireOfSecUser(DateTime verificationCodeExpire)
	{
	...
	public CmsChecker checkLastLoginTimeOfSecUser(DateTime lastLoginTime)
	{
	...
	public CmsChecker checkDomainIdOfSecUser(String domainId)
	{
	...
	public CmsChecker checkVersionOfSecUser(int version)
	{
	...
	public CmsChecker checkIdOfSecUserBlocking(String id)
	{
	...
	public CmsChecker checkWhoOfSecUserBlocking(String who)
	{
	...
	public CmsChecker checkCommentsOfSecUserBlocking(String comments)
	{
	...
	public CmsChecker checkVersionOfSecUserBlocking(int version)
	{
	...
	public CmsChecker checkIdOfUserApp(String id)
	{
	...
	public CmsChecker checkTitleOfUserApp(String title)
	{
	...
	public CmsChecker checkSecUserIdOfUserApp(String secUserId)
	{
	...
	public CmsChecker checkAppIconOfUserApp(String appIcon)
	{
	...
	public CmsChecker checkFullAccessOfUserApp(boolean fullAccess)
	{
	...
	public CmsChecker checkPermissionOfUserApp(String permission)
	{
	...
	public CmsChecker checkObjectTypeOfUserApp(String objectType)
	{
	...
	public CmsChecker checkObjectIdOfUserApp(String objectId)
	{
	...
	public CmsChecker checkLocationOfUserApp(String location)
	{
	...
	public CmsChecker checkVersionOfUserApp(int version)
	{
	...
	public CmsChecker checkIdOfListAccess(String id)
	{
	...
	public CmsChecker checkNameOfListAccess(String name)
	{
	...
	public CmsChecker checkInternalNameOfListAccess(String internalName)
	{
	...
	public CmsChecker checkReadPermissionOfListAccess(boolean readPermission)
	{
	...
	public CmsChecker checkCreatePermissionOfListAccess(boolean createPermission)
	{
	...
	public CmsChecker checkDeletePermissionOfListAccess(boolean deletePermission)
	{
	...
	public CmsChecker checkUpdatePermissionOfListAccess(boolean updatePermission)
	{
	...
	public CmsChecker checkExecutionPermissionOfListAccess(boolean executionPermission)
	{
	...
	public CmsChecker checkAppIdOfListAccess(String appId)
	{
	...
	public CmsChecker checkVersionOfListAccess(int version)
	{
	...
	public CmsChecker checkIdOfObjectAccess(String id)
	{
	...
	public CmsChecker checkNameOfObjectAccess(String name)
	{
	...
	public CmsChecker checkObjectTypeOfObjectAccess(String objectType)
	{
	...
	public CmsChecker checkList1OfObjectAccess(String list1)
	{
	...
	public CmsChecker checkList2OfObjectAccess(String list2)
	{
	...
	public CmsChecker checkList3OfObjectAccess(String list3)
	{
	...
	public CmsChecker checkList4OfObjectAccess(String list4)
	{
	...
	public CmsChecker checkList5OfObjectAccess(String list5)
	{
	...
	public CmsChecker checkList6OfObjectAccess(String list6)
	{
	...
	public CmsChecker checkList7OfObjectAccess(String list7)
	{
	...
	public CmsChecker checkList8OfObjectAccess(String list8)
	{
	...
	public CmsChecker checkList9OfObjectAccess(String list9)
	{
	...
	public CmsChecker checkAppIdOfObjectAccess(String appId)
	{
	...
	public CmsChecker checkVersionOfObjectAccess(int version)
	{
	...
	public CmsChecker checkIdOfLoginHistory(String id)
	{
	...
	public CmsChecker checkFromIpOfLoginHistory(String fromIp)
	{
	...
	public CmsChecker checkDescriptionOfLoginHistory(String description)
	{
	...
	public CmsChecker checkSecUserIdOfLoginHistory(String secUserId)
	{
	...
	public CmsChecker checkVersionOfLoginHistory(int version)
	{
	...
	public CmsChecker checkIdOfGenericForm(String id)
	{
	...
	public CmsChecker checkTitleOfGenericForm(String title)
	{
	...
	public CmsChecker checkDescriptionOfGenericForm(String description)
	{
	...
	public CmsChecker checkVersionOfGenericForm(int version)
	{
	...
	public CmsChecker checkIdOfFormMessage(String id)
	{
	...
	public CmsChecker checkTitleOfFormMessage(String title)
	{
	...
	public CmsChecker checkFormIdOfFormMessage(String formId)
	{
	...
	public CmsChecker checkLevelOfFormMessage(String level)
	{
	...
	public CmsChecker checkVersionOfFormMessage(int version)
	{
	...
	public CmsChecker checkIdOfFormFieldMessage(String id)
	{
	...
	public CmsChecker checkTitleOfFormFieldMessage(String title)
	{
	...
	public CmsChecker checkParameterNameOfFormFieldMessage(String parameterName)
	{
	...
	public CmsChecker checkFormIdOfFormFieldMessage(String formId)
	{
	...
	public CmsChecker checkLevelOfFormFieldMessage(String level)
	{
	...
	public CmsChecker checkVersionOfFormFieldMessage(int version)
	{
	...
	public CmsChecker checkIdOfFormField(String id)
	{
	...
	public CmsChecker checkLabelOfFormField(String label)
	{
	...
	public CmsChecker checkLocaleKeyOfFormField(String localeKey)
	{
	...
	public CmsChecker checkParameterNameOfFormField(String parameterName)
	{
	...
	public CmsChecker checkTypeOfFormField(String type)
	{
	...
	public CmsChecker checkFormIdOfFormField(String formId)
	{
	...
	public CmsChecker checkPlaceholderOfFormField(String placeholder)
	{
	...
	public CmsChecker checkDefaultValueOfFormField(String defaultValue)
	{
	...
	public CmsChecker checkDescriptionOfFormField(String description)
	{
	...
	public CmsChecker checkFieldGroupOfFormField(String fieldGroup)
	{
	...
	public CmsChecker checkMinimumValueOfFormField(String minimumValue)
	{
	...
	public CmsChecker checkMaximumValueOfFormField(String maximumValue)
	{
	...
	public CmsChecker checkRequiredOfFormField(boolean required)
	{
	...
	public CmsChecker checkDisabledOfFormField(boolean disabled)
	{
	...
	public CmsChecker checkCustomRenderingOfFormField(boolean customRendering)
	{
	...
	public CmsChecker checkCandidateValuesOfFormField(String candidateValues)
	{
	...
	public CmsChecker checkSuggestValuesOfFormField(String suggestValues)
	{
	...
	public CmsChecker checkVersionOfFormField(int version)
	{
	...
	public CmsChecker checkIdOfFormAction(String id)
	{
	...
	public CmsChecker checkLabelOfFormAction(String label)
	{
	...
	public CmsChecker checkLocaleKeyOfFormAction(String localeKey)
	{
	...
	public CmsChecker checkActionKeyOfFormAction(String actionKey)
	{
	...
	public CmsChecker checkLevelOfFormAction(String level)
	{
	...
	public CmsChecker checkUrlOfFormAction(String url)
	{
	...
	public CmsChecker checkFormIdOfFormAction(String formId)
	{
	...
	public CmsChecker checkVersionOfFormAction(int version)
	{
