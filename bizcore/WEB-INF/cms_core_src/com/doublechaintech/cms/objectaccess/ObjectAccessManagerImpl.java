...
public class ObjectAccessManagerImpl extends CustomCmsCheckerManager implements ObjectAccessManager {
	...
	protected void throwExceptionWithMessage(String value) throws ObjectAccessManagerException{
 	...
 	protected ObjectAccess saveObjectAccess(CmsUserContext userContext, ObjectAccess objectAccess, String [] tokensExpr) throws Exception{	
 	...
 	protected ObjectAccess saveObjectAccessDetail(CmsUserContext userContext, ObjectAccess objectAccess) throws Exception{	
 	...
 	public ObjectAccess loadObjectAccess(CmsUserContext userContext, String objectAccessId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ObjectAccess searchObjectAccess(CmsUserContext userContext, String objectAccessId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ObjectAccess present(CmsUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens) throws Exception {
 	...
 	public ObjectAccess loadObjectAccessDetail(CmsUserContext userContext, String objectAccessId) throws Exception{	
 	...
 	public Object view(CmsUserContext userContext, String objectAccessId) throws Exception{	
 		ObjectAccess objectAccess = loadObjectAccess( userContext, objectAccessId, viewTokens());
 		return present(userContext,objectAccess, allTokens());
		
 	}
 	protected ObjectAccess saveObjectAccess(CmsUserContext userContext, ObjectAccess objectAccess, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getObjectAccessDAO().save(objectAccess, tokens);
 	}
 	protected ObjectAccess loadObjectAccess(CmsUserContext userContext, String objectAccessId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfObjectAccess(objectAccessId);
		userContext.getChecker().throwExceptionIfHasErrors( ObjectAccessManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(CmsUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(CmsUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingObjectAccess(CmsUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ObjectAccess clone(CmsUserContext userContext, String fromObjectAccessId) throws Exception{
	...
	public ObjectAccess internalSaveObjectAccess(CmsUserContext userContext, ObjectAccess objectAccess, Map<String,Object> options) throws Exception 
	{
	...
	public ObjectAccess updateObjectAccessProperty(CmsUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingObjectAccess(userContext, objectAccessId, objectAccessVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(CmsUserContext userContext, String objectAccessId, String anotherAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(CmsUserContext userContext, String objectAccessId, int objectAccessVersion) throws Exception {
	...
	public ObjectAccess forgetByAll(CmsUserContext userContext, String objectAccessId, int objectAccessVersion) throws Exception {
		return forgetByAllInternal(userContext, objectAccessId, objectAccessVersion);		
	}
	protected ObjectAccess forgetByAllInternal(CmsUserContext userContext,
			String objectAccessId, int objectAccessVersion) throws Exception{
