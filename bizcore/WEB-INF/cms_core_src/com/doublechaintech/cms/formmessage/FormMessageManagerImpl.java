...
public class FormMessageManagerImpl extends CustomCmsCheckerManager implements FormMessageManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormMessageManagerException{
 	...
 	protected FormMessage saveFormMessage(CmsUserContext userContext, FormMessage formMessage, String [] tokensExpr) throws Exception{	
 	...
 	protected FormMessage saveFormMessageDetail(CmsUserContext userContext, FormMessage formMessage) throws Exception{	
 	...
 	public FormMessage loadFormMessage(CmsUserContext userContext, String formMessageId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormMessage searchFormMessage(CmsUserContext userContext, String formMessageId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormMessage present(CmsUserContext userContext, FormMessage formMessage, Map<String, Object> tokens) throws Exception {
 	...
 	public FormMessage loadFormMessageDetail(CmsUserContext userContext, String formMessageId) throws Exception{	
 	...
 	public Object view(CmsUserContext userContext, String formMessageId) throws Exception{	
 		FormMessage formMessage = loadFormMessage( userContext, formMessageId, viewTokens());
 		return present(userContext,formMessage, allTokens());
		
 	}
 	protected FormMessage saveFormMessage(CmsUserContext userContext, FormMessage formMessage, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormMessageDAO().save(formMessage, tokens);
 	}
 	protected FormMessage loadFormMessage(CmsUserContext userContext, String formMessageId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormMessage(formMessageId);
		userContext.getChecker().throwExceptionIfHasErrors( FormMessageManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(CmsUserContext userContext, FormMessage formMessage, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(CmsUserContext userContext, FormMessage formMessage, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormMessage(CmsUserContext userContext,String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormMessage clone(CmsUserContext userContext, String fromFormMessageId) throws Exception{
	...
	public FormMessage internalSaveFormMessage(CmsUserContext userContext, FormMessage formMessage, Map<String,Object> options) throws Exception 
	{
	...
	public FormMessage updateFormMessageProperty(CmsUserContext userContext,String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormMessage(userContext, formMessageId, formMessageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(CmsUserContext userContext, String formMessageId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(CmsUserContext userContext, String formMessageId, int formMessageVersion) throws Exception {
	...
	public FormMessage forgetByAll(CmsUserContext userContext, String formMessageId, int formMessageVersion) throws Exception {
		return forgetByAllInternal(userContext, formMessageId, formMessageVersion);		
	}
	protected FormMessage forgetByAllInternal(CmsUserContext userContext,
			String formMessageId, int formMessageVersion) throws Exception{
