...
public class UserDomainManagerImpl extends CustomCmsCheckerManager implements UserDomainManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserDomainManagerException{
 	...
 	protected UserDomain saveUserDomain(CmsUserContext userContext, UserDomain userDomain, String [] tokensExpr) throws Exception{	
 	...
 	protected UserDomain saveUserDomainDetail(CmsUserContext userContext, UserDomain userDomain) throws Exception{	
 	...
 	public UserDomain loadUserDomain(CmsUserContext userContext, String userDomainId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserDomain searchUserDomain(CmsUserContext userContext, String userDomainId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserDomain present(CmsUserContext userContext, UserDomain userDomain, Map<String, Object> tokens) throws Exception {
 	...
 	public UserDomain loadUserDomainDetail(CmsUserContext userContext, String userDomainId) throws Exception{	
 		UserDomain userDomain = loadUserDomain( userContext, userDomainId, allTokens());
 		return present(userContext,userDomain, allTokens());
		
 	}
 	
 	public Object view(CmsUserContext userContext, String userDomainId) throws Exception{	
 		UserDomain userDomain = loadUserDomain( userContext, userDomainId, viewTokens());
 		return present(userContext,userDomain, allTokens());
		
 	}
 	protected UserDomain saveUserDomain(CmsUserContext userContext, UserDomain userDomain, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserDomainDAO().save(userDomain, tokens);
 	}
 	protected UserDomain loadUserDomain(CmsUserContext userContext, String userDomainId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserDomain(userDomainId);
		userContext.getChecker().throwExceptionIfHasErrors( UserDomainManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(CmsUserContext userContext, UserDomain userDomain, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(CmsUserContext userContext, UserDomain userDomain, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserDomain(CmsUserContext userContext,String userDomainId, int userDomainVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserDomain clone(CmsUserContext userContext, String fromUserDomainId) throws Exception{
	...
	public UserDomain internalSaveUserDomain(CmsUserContext userContext, UserDomain userDomain, Map<String,Object> options) throws Exception 
	{
	...
	public UserDomain updateUserDomainProperty(CmsUserContext userContext,String userDomainId, int userDomainVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserDomain(userContext, userDomainId, userDomainVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(CmsUserContext userContext, String userDomainId, int userDomainVersion) throws Exception {
	...
	public UserDomain forgetByAll(CmsUserContext userContext, String userDomainId, int userDomainVersion) throws Exception {
		return forgetByAllInternal(userContext, userDomainId, userDomainVersion);		
	}
	protected UserDomain forgetByAllInternal(CmsUserContext userContext,
			String userDomainId, int userDomainVersion) throws Exception{
	...
	protected void checkParamsForAddingUserWhiteList(CmsUserContext userContext, String userDomainId, String userIdentity, String userSpecialFunctions,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserWhiteListProperties(CmsUserContext userContext, String userDomainId,String id,String userIdentity,String userSpecialFunctions,String [] tokensExpr) throws Exception {
	...
	public  UserDomain updateUserWhiteListProperties(CmsUserContext userContext, String userDomainId, String id,String userIdentity,String userSpecialFunctions, String [] tokensExpr) throws Exception
	{	
	...
	protected UserWhiteList createUserWhiteList(CmsUserContext userContext, String userIdentity, String userSpecialFunctions) throws Exception{
	...
	protected void checkParamsForRemovingUserWhiteListList(CmsUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeUserWhiteListList(CmsUserContext userContext, String userDomainId, 
			String userWhiteListIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUserWhiteList(CmsUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeUserWhiteList(CmsUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUserWhiteList(CmsUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	public  UserDomain copyUserWhiteListFrom(CmsUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserWhiteList(CmsUserContext userContext, String userDomainId, String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserDomain updateUserWhiteList(CmsUserContext userContext, String userDomainId, String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingSecUser(CmsUserContext userContext, String userDomainId, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUserProperties(CmsUserContext userContext, String userDomainId,String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  UserDomain updateSecUserProperties(CmsUserContext userContext, String userDomainId, String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{	
	...
	protected SecUser createSecUser(CmsUserContext userContext, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime) throws Exception{
	...
	protected void checkParamsForRemovingSecUserList(CmsUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeSecUserList(CmsUserContext userContext, String userDomainId, 
			String secUserIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSecUser(CmsUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeSecUser(CmsUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSecUser(CmsUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	public  UserDomain copySecUserFrom(CmsUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUser(CmsUserContext userContext, String userDomainId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserDomain updateSecUser(CmsUserContext userContext, String userDomainId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
