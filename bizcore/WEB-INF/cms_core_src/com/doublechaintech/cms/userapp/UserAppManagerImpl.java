...
public class UserAppManagerImpl extends CustomCmsCheckerManager implements UserAppManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserAppManagerException{
 	...
 	protected UserApp saveUserApp(CmsUserContext userContext, UserApp userApp, String [] tokensExpr) throws Exception{	
 	...
 	protected UserApp saveUserAppDetail(CmsUserContext userContext, UserApp userApp) throws Exception{	
 	...
 	public UserApp loadUserApp(CmsUserContext userContext, String userAppId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserApp searchUserApp(CmsUserContext userContext, String userAppId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserApp present(CmsUserContext userContext, UserApp userApp, Map<String, Object> tokens) throws Exception {
 	...
 	public UserApp loadUserAppDetail(CmsUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, allTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	
 	public Object view(CmsUserContext userContext, String userAppId) throws Exception{	
 		UserApp userApp = loadUserApp( userContext, userAppId, viewTokens());
 		return present(userContext,userApp, allTokens());
		
 	}
 	protected UserApp saveUserApp(CmsUserContext userContext, UserApp userApp, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserAppDAO().save(userApp, tokens);
 	}
 	protected UserApp loadUserApp(CmsUserContext userContext, String userAppId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserApp(userAppId);
		userContext.getChecker().throwExceptionIfHasErrors( UserAppManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(CmsUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(CmsUserContext userContext, UserApp userApp, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserApp(CmsUserContext userContext,String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserApp clone(CmsUserContext userContext, String fromUserAppId) throws Exception{
	...
	public UserApp internalSaveUserApp(CmsUserContext userContext, UserApp userApp, Map<String,Object> options) throws Exception 
	{
	...
	public UserApp updateUserAppProperty(CmsUserContext userContext,String userAppId, int userAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserApp(userContext, userAppId, userAppVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(CmsUserContext userContext, String userAppId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(CmsUserContext userContext, String userAppId, String anotherLogin) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithLogin(CmsUserContext userContext, String userAppId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(CmsUserContext userContext, String userAppId, String anotherEmail) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithEmail(CmsUserContext userContext, String userAppId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(CmsUserContext userContext, String userAppId, String anotherMobile) throws Exception
 	{
 	...
 	public UserApp transferToAnotherSecUserWithMobile(CmsUserContext userContext, String userAppId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(CmsUserContext userContext, String userAppId, int userAppVersion) throws Exception {
	...
	public UserApp forgetByAll(CmsUserContext userContext, String userAppId, int userAppVersion) throws Exception {
		return forgetByAllInternal(userContext, userAppId, userAppVersion);		
	}
	protected UserApp forgetByAllInternal(CmsUserContext userContext,
			String userAppId, int userAppVersion) throws Exception{
	...
	protected void checkParamsForAddingListAccess(CmsUserContext userContext, String userAppId, String name, String internalName, boolean readPermission, boolean createPermission, boolean deletePermission, boolean updatePermission, boolean executionPermission,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingListAccessProperties(CmsUserContext userContext, String userAppId,String id,String name,String internalName,boolean readPermission,boolean createPermission,boolean deletePermission,boolean updatePermission,boolean executionPermission,String [] tokensExpr) throws Exception {
	...
	public  UserApp updateListAccessProperties(CmsUserContext userContext, String userAppId, String id,String name,String internalName,boolean readPermission,boolean createPermission,boolean deletePermission,boolean updatePermission,boolean executionPermission, String [] tokensExpr) throws Exception
	{	
	...
	protected ListAccess createListAccess(CmsUserContext userContext, String name, String internalName, boolean readPermission, boolean createPermission, boolean deletePermission, boolean updatePermission, boolean executionPermission) throws Exception{
	...
	protected void checkParamsForRemovingListAccessList(CmsUserContext userContext, String userAppId, 
	...
	public  UserApp removeListAccessList(CmsUserContext userContext, String userAppId, 
			String listAccessIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingListAccess(CmsUserContext userContext, String userAppId, 
	...
	public  UserApp removeListAccess(CmsUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingListAccess(CmsUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyListAccessFrom(CmsUserContext userContext, String userAppId, 
		String listAccessId, int listAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingListAccess(CmsUserContext userContext, String userAppId, String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateListAccess(CmsUserContext userContext, String userAppId, String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingObjectAccess(CmsUserContext userContext, String userAppId, String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingObjectAccessProperties(CmsUserContext userContext, String userAppId,String id,String name,String objectType,String list1,String list2,String list3,String list4,String list5,String list6,String list7,String list8,String list9,String [] tokensExpr) throws Exception {
	...
	public  UserApp updateObjectAccessProperties(CmsUserContext userContext, String userAppId, String id,String name,String objectType,String list1,String list2,String list3,String list4,String list5,String list6,String list7,String list8,String list9, String [] tokensExpr) throws Exception
	{	
	...
	protected ObjectAccess createObjectAccess(CmsUserContext userContext, String name, String objectType, String list1, String list2, String list3, String list4, String list5, String list6, String list7, String list8, String list9) throws Exception{
	...
	protected void checkParamsForRemovingObjectAccessList(CmsUserContext userContext, String userAppId, 
	...
	public  UserApp removeObjectAccessList(CmsUserContext userContext, String userAppId, 
			String objectAccessIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingObjectAccess(CmsUserContext userContext, String userAppId, 
	...
	public  UserApp removeObjectAccess(CmsUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingObjectAccess(CmsUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	public  UserApp copyObjectAccessFrom(CmsUserContext userContext, String userAppId, 
		String objectAccessId, int objectAccessVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingObjectAccess(CmsUserContext userContext, String userAppId, String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserApp updateObjectAccess(CmsUserContext userContext, String userAppId, String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
