<%@ page import='java.util.*,com.doublechaintech.cms.*,com.doublechaintech.cms.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/cms/userwhitelist/UserWhiteList$Summary.jsp" />
