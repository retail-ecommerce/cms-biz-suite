<%@ page import='java.util.*,com.doublechaintech.cms.*,com.doublechaintech.cms.platform.Platform'%>
...
<sky:include page="com/doublechaintech/cms/platform/Platform$Summary.jsp" />
