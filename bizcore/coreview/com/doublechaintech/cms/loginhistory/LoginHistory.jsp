<%@ page import='java.util.*,com.doublechaintech.cms.*,com.doublechaintech.cms.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/cms/loginhistory/LoginHistory$Summary.jsp" />
