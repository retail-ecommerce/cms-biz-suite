<%@ page import='java.util.*,com.doublechaintech.cms.*,com.doublechaintech.cms.alertbar.AlertBar'%>
...
<c:set var="ownerBeanName" value="alertBar" scope="request"/>
<c:set var="ownerClassName" value="AlertBar" scope="request"/>
...
<div class="row">
	...
	<% AlertBar result = (AlertBar)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="alertBar" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/cms/alertbar/AlertBar$Summary.jsp" />
