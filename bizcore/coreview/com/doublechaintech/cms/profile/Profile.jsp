<%@ page import='java.util.*,com.doublechaintech.cms.*,com.doublechaintech.cms.profile.Profile'%>
...
<sky:include page="com/doublechaintech/cms/profile/Profile$Summary.jsp" />
