<%@ page import='java.util.*,com.doublechaintech.cms.*,com.doublechaintech.cms.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/cms/formmessage/FormMessage$Summary.jsp" />
