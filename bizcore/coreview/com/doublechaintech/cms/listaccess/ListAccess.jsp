<%@ page import='java.util.*,com.doublechaintech.cms.*,com.doublechaintech.cms.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/cms/listaccess/ListAccess$Summary.jsp" />
