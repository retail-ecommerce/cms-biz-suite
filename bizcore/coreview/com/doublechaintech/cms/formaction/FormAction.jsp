<%@ page import='java.util.*,com.doublechaintech.cms.*,com.doublechaintech.cms.formaction.FormAction'%>
...
<sky:include page="com/doublechaintech/cms/formaction/FormAction$Summary.jsp" />
