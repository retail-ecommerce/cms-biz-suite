<%@ page import='java.util.*,com.doublechaintech.cms.*,com.doublechaintech.cms.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechaintech/cms/secuserblocking/SecUserBlocking$Summary.jsp" />
