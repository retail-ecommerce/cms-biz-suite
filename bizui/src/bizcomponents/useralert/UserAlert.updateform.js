...
import styles from './UserAlert.updateform.less'
...
class UserAlertUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const userAlertId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, userAlertId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateUserAlert`,
          payload: {
            id: owner.id,
            type: 'userAlert',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextUserAlertUpdateRow`,
        payload: {
          id: owner.id,
          type: 'userAlert',
          selectedRows,
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item>
                  {getFieldDecorator('message', {
                  	initialValue: selectedRow.message,
                    rules: [{  required: true, message: appLocaleName(userContext,"PleaseInput") }],
                  })(
...
}))(Form.create()(UserAlertUpdateForm))
