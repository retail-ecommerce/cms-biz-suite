...
import styles from './UserAlert.search.less'
...
class UserAlertSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      userAlertList: 1,
      'userAlertList.searchField': fieldName,
      'userAlertList.searchVerb': 'startsWith',
      'userAlertList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`userAlertList.searchField`] = fieldName
    value[`userAlertList.searchVerb`] =  searchVerb
    value[`userAlertList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'message'))
      ...
      params['userAlertList'] = 1
      params['userAlertList.orderBy.0'] = "id"
      params['userAlertList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        userAlertSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"profile"} 
                    requestFunction={UserAlertService.requestCandidateProfile}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={UserAlertService.requestCandidatePlatform}/>
...
export default Form.create()(UserAlertSearchForm)
