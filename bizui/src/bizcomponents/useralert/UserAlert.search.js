...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{userAlertList:selectedRows}} owner={owner}  
...
class UserAlertSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {UserAlertTable} = GlobalComponents;
    const {UserAlertSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <UserAlertSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,UserAlertModalTable,"userAlertIds")}
...
export default Form.create()(UserAlertSearch)
