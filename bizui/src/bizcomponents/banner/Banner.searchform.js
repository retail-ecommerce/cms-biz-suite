...
componentDidMount() {
  ...
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`bannerList.searchField`] = fieldName
    value[`bannerList.searchVerb`] =  searchVerb
    value[`bannerList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['bannerList'] = 1
      params['bannerList.orderBy.0'] = "id"
      params['bannerList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        bannerSearchFormParameters: filterObjectKeys(fieldsValue),
