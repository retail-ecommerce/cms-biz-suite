...
import styles from './Target.search.less'
...
class TargetSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      targetList: 1,
      'targetList.searchField': fieldName,
      'targetList.searchVerb': 'startsWith',
      'targetList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`targetList.searchField`] = fieldName
    value[`targetList.searchVerb`] =  searchVerb
    value[`targetList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'banner'))
      ...
      params['targetList'] = 1
      params['targetList.orderBy.0'] = "id"
      params['targetList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        targetSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"profile"} 
                    requestFunction={TargetService.requestCandidateProfile}/>
...
export default Form.create()(TargetSearchForm)
