...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{alertBarList:selectedRows}} owner={owner}  
...
class AlertBarSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {AlertBarTable} = GlobalComponents;
    const {AlertBarSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}${appLocaleName(userContext,"List")}`}>
        ...
        {showDeletionDialog(this,AlertBarModalTable,"alertBarIds")}
...
export default Form.create()(AlertBarSearch)
