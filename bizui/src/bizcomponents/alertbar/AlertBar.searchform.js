...
import styles from './AlertBar.search.less'
...
class AlertBarSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      alertBarList: 1,
      'alertBarList.searchField': fieldName,
      'alertBarList.searchVerb': 'startsWith',
      'alertBarList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`alertBarList.searchField`] = fieldName
    value[`alertBarList.searchVerb`] =  searchVerb
    value[`alertBarList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['alertBarList'] = 1
      params['alertBarList.orderBy.0'] = "id"
      params['alertBarList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        alertBarSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={AlertBarService.requestCandidatePlatform}/>
...
export default Form.create()(AlertBarSearchForm)
