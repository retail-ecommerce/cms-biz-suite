...
import styles from './AlertBar.updateform.less'
...
class AlertBarUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const alertBarId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, alertBarId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateAlertBar`,
          payload: {
            id: owner.id,
            type: 'alertBar',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextAlertBarUpdateRow`,
        payload: {
          id: owner.id,
          type: 'alertBar',
          selectedRows,
...
}))(Form.create()(AlertBarUpdateForm))
